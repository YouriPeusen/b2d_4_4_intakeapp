            ...
            <table class="auto-style17">
                <tr>
                    ...
                    <td class="auto-style15">
                        ...
                        <asp:SqlDataSource ID="SqlDataS6ource5" runat="server" ConnectionString="<%$ ConnectionStrings:RuilwinkelDBConnectionString %>" SelectCommand="SELECT * FROM [Categories]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7">&nbsp;</td>
